...
export const translations: Record<LanguageOption, Record<TranslationKey, string>> = {
  Korean: {
    ...
    'home.todayDeadlines': '이번 주 마감 공지',
    'home.todayDeadlinesEmpty': '이번 주에 마감하는 공지가 없습니다.',
    ...
    'auth.profile.languageSemesterLabel': '현재 한국어과정 학기',
    ...
    'chat.welcome': '안녕하세요. 아주대학교 유학생을 돕는 안내 챗봇입니다. 오늘은 무엇을 도와드릴까요?',
    'chat.placeholder': '질문을 입력하세요...',
    'chat.error': '죄송합니다. 응답을 가져오는 중에 오류가 발생했습니다.',
    'chat.topicTitle': '자주 찾는 주제',
    'chat.topic.topik': 'TOPIK 시험 일정',
    'chat.topic.visa': '비자 연장',
    'chat.topic.dorm': '기숙사 신청',
    'chat.topic.scholarship': '장학금',
    'chat.topic.topikQuery': 'TOPIK 시험 일정 알려줘',
    'chat.topic.visaQuery': '비자 연장 방법 알려줘',
    'chat.topic.dormQuery': '기숙사 신청 방법 알려줘',
    'chat.topic.scholarshipQuery': '장학금 정보 알려줘',
  },
  English: {
    'tabs.home': 'Home',
    'tabs.chat': 'Chat',
    ...
    'home.todayDeadlines': "This Week's Deadline Notices",
    'home.todayDeadlinesEmpty': 'No notices are due this week.',
    ...
    'auth.profile.languageSemesterLabel': 'Current Korean program term',
    ...
    'chat.welcome': 'Hello! I am the guidance chatbot helping international students at Ajou University. How can I help you today?',
    'chat.placeholder': 'Enter your question...',
    'chat.error': 'Sorry, an error occurred while fetching the response.',
    'chat.topicTitle': 'Common Topics',
    'chat.topic.topik': 'TOPIK Exam Schedule',
    'chat.topic.visa': 'Visa Extension',
    'chat.topic.dorm': 'Dormitory Application',
    'chat.topic.scholarship': 'Scholarship',
    'chat.topic.topikQuery': 'Tell me the TOPIK exam schedule',
    'chat.topic.visaQuery': 'Tell me how to extend my visa',
    'chat.topic.dormQuery': 'Tell me how to apply for the dormitory',
    'chat.topic.scholarshipQuery': 'Tell me about scholarship information',
  },
};
